  ...
  return (
    <div className="body">
      <div>
        ...
        <h2>Proud contractor of EnduroSol®</h2>
        <a className='text'>
          You purchase an Enduro Server package(s) Your server is then
          automatically leased back to Enduro to do its data mining and data
          storage functions. You receive a check every month for 5 years
          basically tripling your money. At the end of that term the server is
          worn out and basically you are done, unless of course you continue to
          buy more servers.
        </a>
        <br></br>
      </div>
